...
```
Para instalar paquetes desde GitHub. Previamente se debe de haber instalado el paquete **devtools**.

```r
devtools::install_github("tylermorganwall/rayshader") # Función para instalar paquetes desde GitHub
```
