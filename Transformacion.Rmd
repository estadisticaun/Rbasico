...
# Forma general 
file1_csv <- read.table(file = "Datos/Archivo2.csv", header = TRUE, sep = ",")
head(file1_csv)
```
...
file3_csv <- read.csv2(file = "Datos/Archivo3.csv", header = TRUE)
head(file3_csv)
```
