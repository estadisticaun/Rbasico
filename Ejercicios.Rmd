...
+ Modificar/cambiar por 3000 el valor de la variable `wt` del individuo ubicado en la posición 1 (fila 1). Guardar e imprimir los resultados de los primeros 5 individuos en un objeto llamado `mtcars_modif`.
